...
TEST_CASE("value_domain::clamp(T value)", "[working][unittest][value_domain]")
{
	...
	{
		value_domain<vector2> domain{{-0.3f, 1.2f}, {4.44f, 5.25f}};
          ...
          "[working][unittest][value_domain]")
{
	...
	value_domain<vector2> domain3{{0.0f, 0.0f}, {1.0f, 1.0f}};

	CHECK(domain3.lerp(normalized_value<vector2>({0.0f, 0.0f})) ==
	      domain3.lim0());
	CHECK(domain3.lerp(normalized_value<vector2>({1.0f, 1.0f})) ==
	      domain3.lim1());
	CHECK(domain3.lerp(normalized_value<vector2>({0.25f, 0.25f})) ==
	      vector2{0.25f, 0.25f});
	CHECK(domain3.lerp(normalized_value<vector2>({0.5f, 0.5f})) ==
	      vector2{0.5f, 0.5f});
	CHECK(domain3.lerp(normalized_value<vector2>({0.75f, 0.75f})) ==
	      vector2{0.75f, 0.75f});
	CHECK(domain3.lerp(normalized_value<vector2>(
	          {-145600.75f, -145600.75f})) == domain3.lim0());
	CHECK(domain3.lerp(normalized_value<vector2>({1000.75f, 1000.75f})) ==
	      domain3.lim1());

	value_domain<vector2> domain4{{1.0f, 1.0f}, {0.0f, 0.0f}};

	CHECK(domain4.lerp(normalized_value<vector2>({0.0f, 0.0f})) ==
	      domain4.lim0());
	CHECK(domain4.lerp(normalized_value<vector2>({1.0f, 1.0f})) ==
	      domain4.lim1());
	CHECK(domain4.lerp(normalized_value<vector2>({0.25f, 0.25f})) ==
	      vector2{0.75f, 0.75f});
	CHECK(domain4.lerp(normalized_value<vector2>({0.5f, 0.5f})) ==
	      vector2{0.5f, 0.5f});
	CHECK(domain4.lerp(normalized_value<vector2>({0.75f, 0.75f})) ==
	      vector2{0.25f, 0.25f});
	CHECK(domain4.lerp(normalized_value<vector2>(
	          {-145600.75f, -145600.75f})) == domain4.lim0());
	CHECK(domain4.lerp(normalized_value<vector2>({1000.75f, 1000.75f})) ==
	      domain4.lim1());
}

TEST_CASE("normalized_value::normalized_value()",
          "[working][unittest][value_domain]")
{
	normalized_value v{0.0f};

	CHECK(v.value() == 0.0f);
}

TEST_CASE("normalized_value::normalized_value(value)",
          "[working][unittest][value_domain]")
{
...
TEST_CASE("normalized_value assignation", "[working][unittest][value_domain]")
{
	normalized_value v{0.0f};
	CHECK(v.value() == 0.0f);
...
TEST_CASE("unnormalized_value::unnormalized_value(value_domain[, value])",
          "[working][unittest][value_domain]")
{
	{
...
TEST_CASE("unnormalized_value::setValue(value)",
          "[working][unittest][value_domain]")
{
	value_domain d{1.0f, 2.0f};
	unnormalized_value v{d};
...
TEST_CASE("unnormalized_value::unnormalized_value(normalized_value)",
          "[working][unittest][value_domain]")
{
	{
		value_domain d{1.0f, 2.0f};
...
TEST_CASE("normalized_value::normalized_value(unnormalized_value)",
          "[working][unittest][value_domain]")
{
	{
		value_domain d{1.0f, 2.0f};
